              ...
              <div className="cart_box">
                {cartData.map((item, index) => (
                  <div key={index} className="cart_d">
                    <div className="left">
                      <img
                        src="https://olcha.uz/image/original/products/cdn_1/supplier/stores/1/2024-10-28/2LuMm7dzhQZaMZaIEQnJsH7wj3AqG0vt6OJsI1Fy7wAlhVbpcMH6CZrwVm4N.jpg"
                        alt=""
                      />
                      <div className="cart_lorme">
                        <Link className="oyin_konsoli">{item.name}</Link>
                        <p style={{ color: "#999" }}>Audio Magaza</p>
                        {/* <div style={{ display: "flex", color: "#999", }}>
>>>>>>> 64d840d34d81b5002a0425a465f76ae7019c035d
                    ...
                    <p>Dubaydan</p>
                        ...
                        <Link className="sevimlilar">
                          Sevimlilarga qo'shish <p>|</p> Oʻchirish
                        </Link>
                      </div>
                    </div>
                    <div className="right">
...
>>>>>>> 64d840d34d81b5002a0425a465f76ae7019c035d
          ...
          <div className="cart_item_left">
            <div className="jami">
              <h1>Jami:</h1>
              <h1 style={{ fontFamily: "sans-serif" }}>7 300 000 so'm</h1>
            </div>
            <p className="tejov">
              Tejovingiz:
